...
public class ReferenceType extends Type {
    ...
    public boolean isCompatibleWithType(Type typeToCompareWith) {
        //System.out.println("Entre aca con: "+typeToCompareWith);
        ...
        if (concreteClass != null && comparingInterface != null) {
            //System.out.println("Clase concreta: "+concreteClass.getClassName());
            //System.out.println("Interface: "+comparingInterface.getClassName());
